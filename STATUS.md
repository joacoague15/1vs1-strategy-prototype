...
24. Sprites geometricos por unidad (reemplazan cuadrado + letra): Zergling = estrella de 4 puntas, Hydralisk = rombo alto, Roach = hexagono ancho con linea de caparazon, Marine = cuadrado con visor, Hellbat = triangulo con nucleo de llama, Medic = circulo con cruz blanca. Colores por unidad siguen viniendo de units.json. Preview visual en tests/sprites_preview.tscn (genera screenshot y sale)
